...
checksum-and-size-pinned OSV-Scanner 2.4.0 binary, download the public advisory
database, and then match dependencies locally with network resolution disabled.
No package inventory or repository path is sent to OSV.dev.
